...
#        print map_headers
    ...
    def enemize(self,f,rom_offset=0):
        ...
        for map in self.maps:
            ...
            # Gather map event address range data from ROM
            f.seek(int("c8000",16) + 2*map + rom_offset)
            byte_low = f.read(1)
            byte_high = f.read(1)
            nextbyte_low = f.read(1)
    ...
    def __init__(self, seed, mode, goal="Dark Gaia", logic_mode="Completable",statues=[1,2,3,4,5,6],
        ...
        #           SpritesetOffset,RestrictedEnemysets]}
        # ROM address for room reward table is mapID + $1aade
        self.maps = {
            # Underground Tunnel
            12: [0,1,0,"\x0C\x00\x02\x05\x03",4,[]],
            13: [0,1,0,"\x0D\x00\x02\x03\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            14: [0,1,0,"\x0E\x00\x02\x03\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],  # Statues, spike balls
            15: [0,1,0,"\x0F\x00\x02\x03\x03",4,[]],
...
#            27: [1,0,0,"\x1B\x00\x02\x05\x03\x00\x10\x10\xBC\x33\xC2\x01",4,[0,1]],  # Moon Tribe cave
            ...
            34: [2,1,0,"\x22\x00\x02\x08\x03",4,[]],  # Floor switch
            35: [2,1,0,"\x23\x00\x02\x0A\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            37: [1,1,0,"\x25\x00\x02\x08\x03",4,[1]],  # Diamond block
            38: [1,1,0,"\x26\x00\x02\x08\x03",4,[]],  # Broken statues
            39: [1,1,0,"\x27\x00\x02\x0A\x03",4,[]],
            40: [1,1,0,"\x28\x00\x02\x08\x03",4,[1]],  # Falling blocks

            # Diamond Mine
            61: [3,2,0,"\x3D\x00\x02\x08\x03",4,[]],
            62: [3,2,0,"\x3E\x00\x02\x08\x03",4,[]],
            63: [3,2,0,"\x3F\x00\x02\x05\x03",4,[]],
            64: [3,2,0,"\x40\x00\x02\x08\x03",4,[]],  # Trapped laborer (??)
            65: [3,2,0,"\x41\x00\x02\x00\x03",4,[0,2,3,4,5,11]],  # Stationary Grundit
            69: [3,2,0,"\x45\x00\x02\x08\x03",4,[]],
            70: [3,2,0,"\x46\x00\x02\x08\x03",4,[3]],

            # Sky Garden
            77: [4,2,0,"\x4D\x00\x02\x12\x03",4,[]],
            78: [5,2,0,"\x4E\x00\x02\x10\x03",4,[]],
            79: [4,2,0,"\x4F\x00\x02\x12\x03",4,[4,5]],
            80: [5,2,0,"\x50\x00\x02\x10\x03",4,[]],
            81: [4,2,0,"\x51\x00\x02\x12\x03",4,[]],
            82: [5,2,0,"\x52\x00\x02\x10\x03",4,[4,5]],
            83: [4,2,0,"\x53\x00\x02\x12\x03",4,[4,5]],
...
#            92: [6,0,0,"\x5C\x00\x02\x15\x11\x04\x00\xB7\x49\xDB",62,[]],  # Seaside Palace
            ...
            98: [6,3,0,"\x62\x00\x02\x14\x03",4,[]],
            100: [6,3,0,"\x64\x00\x02\x14\x03",4,[]],
            101: [6,3,0,"\x65\x00\x02\x14\x03",4,[6]],

            # Angel Dungeon
            109: [7,3,0,"\x6D\x00\x02\x16\x03",4,[2,7,8,9,11]],  # Add 10's back in once flies are fixed
            110: [7,3,0,"\x6E\x00\x02\x18\x03",4,[2,7,8,9,11]],
            111: [7,3,0,"\x6F\x00\x02\x1B\x03",4,[2,7,8,9,11]],
            112: [7,3,0,"\x70\x00\x02\x16\x03",4,[2,7,8,9,11]],
            113: [7,3,0,"\x71\x00\x02\x18\x03",4,[2,7,8,9,11]],
            114: [7,3,0,"\x72\x00\x02\x18\x03",4,[2,7,8,9,11]],

            # Great Wall
            130: [8,4,0,"\x82\x00\x02\x1D\x03",4,[2,7,8,9,11]],  # Add 10's back in once flies are fixed
            131: [8,4,0,"\x83\x00\x02\x1D\x03",4,[2,7,8,9,11]],
            133: [8,4,0,"\x85\x00\x02\x1D\x03",4,[2,7,8,9,11]],
            134: [8,4,0,"\x86\x00\x02\x1D\x03",4,[2,7,8,9,11]],
            135: [8,4,0,"\x87\x00\x02\x1D\x03",4,[2,7,8,9,11]],
            136: [8,4,0,"\x88\x00\x02\x1D\x03",4,[2,7,8,9,11]],

            # Mt Temple
            160: [9,4,0,"\xA0\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            161: [9,4,0,"\xA1\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            162: [9,4,0,"\xA2\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            163: [9,4,0,"\xA3\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            164: [9,4,0,"\xA4\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            165: [9,4,0,"\xA5\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            166: [9,4,0,"\xA6\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            167: [9,4,0,"\xA7\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            168: [9,4,0,"\xA8\x00\x02\x20\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],

            # Ankor Wat
            176: [10,6,0,"\xB0\x00\x02\x2C\x03",4,[]],
            177: [11,6,0,"\xB1\x00\x02\x08\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]],
            178: [11,6,0,"\xB2\x00\x02\x08\x03",4,[]],
            179: [11,6,0,"\xB3\x00\x02\x08\x03",4,[]],
            180: [11,6,0,"\xB4\x00\x02\x08\x03",4,[]],
            181: [11,6,0,"\xB5\x00\x02\x08\x03",4,[]],
            182: [10,6,0,"\xB6\x00\x02\x2C\x03",4,[]],
            183: [11,6,0,"\xB7\x00\x02\x08\x03",4,[]],  # Earthquaker Golem
            184: [11,6,0,"\xB8\x00\x02\x08\x03",4,[]],
            185: [11,6,0,"\xB9\x00\x02\x08\x03",4,[]],
            186: [10,6,0,"\xBA\x00\x02\x2C\x03",4,[]],
            187: [11,6,0,"\xBB\x00\x02\x08\x03",4,[]],
            188: [11,6,0,"\xBC\x00\x02\x24\x03",4,[]],
            189: [11,6,0,"\xBD\x00\x02\x08\x03",4,[]],
            190: [11,6,0,"\xBE\x00\x02\x08\x03",4,[]],

            # Pyramid
            204: [12,5,0,"\xCC\x00\x02\x08\x03",4,[]],
            206: [12,5,0,"\xCE\x00\x02\x08\x03",4,[]],
            207: [12,5,0,"\xCF\x00\x02\x08\x03",4,[]],
            208: [12,5,0,"\xD0\x00\x02\x08\x03",4,[]],
            209: [12,5,0,"\xD1\x00\x02\x08\x03",4,[]],
            210: [12,5,0,"\xD2\x00\x02\x08\x03",4,[]],
            211: [12,5,0,"\xD3\x00\x02\x08\x03",4,[]],
            ...
            # Jeweler's Mansion
            233: [13,0,0,"\xE9\x00\x02\x22\x03",4,[0,1,2,3,4,5,7,8,9,10,11,12,13]]
...
#            36: [3,"\xf5\xa4\x8a","\x1a","Grundit (stationary)"],  # Can't randomize this guy
            ...
            62: [7,"\x33\xef\x8a","\x2e",1,True,True,"Draco"],
