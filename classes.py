...
#            27: [1,0,0,"\x1c",""],  # Moon Tribe cave
            29: [1,1,0,"\x1D\x00\x02\x0F\x03",22,False],
            32: [1,1,0,"\x20\x00\x02\x08\x06",9,False],  # Broken statue
            33: [2,1,0,"\x21\x00\x02\x08\x06",9,False],  # Floor switch
            34: [2,1,0,"\x22\x00\x02\x08\x06",9,False],  # Floor switch
            35: [2,1,0,"\x23\x00\x02\x0A\x06",14,False],
            37: [1,1,0,"\x25\x00\x02\x08\x06\x01\x2A\x73\xDC",9,True],  # Diamond block
            38: [1,1,0,"\x26\x00\x02\x08\x06\x01\xCB\x56\xDC",9,False],  # Broken statues
            39: [1,1,0,"\x27\x00\x02\x0A\x06\x01\x9A\x67\xDB",14,False],
            40: [1,1,0,"\x28\x00\x02\x08\x06\x01\xED\x21\xDC",9,False],  # Falling blocks
